...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplicationLaunchOptionsKey: Any]?) -> Bool {
        ...
        var initialViewController = storyboard.instantiateViewController(withIdentifier: "LoginNavigationViewController")

        if (isLoggedIn) {
            initialViewController = showConversationViewController()
        }
    ...
    func showConversationViewController() -> UINavigationController {
        let storyboard = UIStoryboard(name: "Main", bundle: nil)
        ...
        conversationsViewController.senderId = UserManager().userNumber()
        conversationsViewController.senderDisplayName = UserManager().userDisplayName()
